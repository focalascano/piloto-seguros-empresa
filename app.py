...
""",
    "AP": """
**Seguros a presentar por la Contratista para el personal contratado que NO se encuentre en relación de dependencia, y que deba ingresar a predio de SOFSA en virtud de la presente contratación:** **Seguro de Accidentes Personales:**
...
st.caption("**Versión 1.0 – 2026** **Autores:** Diego Martín Morris, Ignacio Khoury.")
...
r6 = st.radio("¿La actividad corresponde a un trabajo menor de mantenimiento simple?", opciones, index=0)
r7 = st.radio("¿La actividad requiere uso de equipos o herramientas complejas?", opciones, index=0)
r8 = st.radio("¿La actividad incluye tareas críticas (altura, soldadura, izaje)?", opciones, index=0)
r9 = st.radio("¿La actividad implica construir o montar una obra nueva?", opciones, index=0)
